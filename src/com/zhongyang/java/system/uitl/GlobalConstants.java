...
public class GlobalConstants {
    ...
    public static final int INVEST_INTEREST_FEE = 10;
    public static final String CLIENT_MOBILE = "15311340737"; //平台手机号
...
//    public static Map<String, List<SysAuthorization>> authMap = new ConcurrentHashMap<String, List<SysAuthorization>>();
    ...
    public static final String PDFHOME="/Users/maxiangxin/javalab/lab/";
}