...
public class Validator {
     ...
     * 正则表达式：验证身份证
     */
    public static final String REGEX_ID_CARD = "(\\d{14}[0-9xX])|(\\d{17}[0-9xX])";
    ...
    public static void main(String[] args) {
        String digit = "13145678941";
        System.out.println(Validator.isMobile(digit));
    }
}
