...
public class LoanTransRecordServiceImpl implements LoanTransRecordService {
	...
	private Logger logger=Logger.getLogger(LoanTransRecordServiceImpl.class);
	...
	@Override
	@Transactional
	public int batchAddRecords(List<LoanTransRecord> list) {
		return loanTransRecordDao.batchInsertRecords(list);
	}
